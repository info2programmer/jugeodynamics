...
<body>
  ...
  <div class="login-container">
    <?php if($this->session->flashdata('error_message')): ?>
        <h3 style="color: #fb860a;" id="message"><?php echo $this->session->flashdata('error_message') ?></h3>
    <?php endif ?>
    ...
    <form  method="POST" class="form login" autocomplete="off" action="<?php echo base_url() ?>login.html">
  ...
  <script src="<?php echo base_url() ?>assets/admin/js/cartoon.js"></script>
